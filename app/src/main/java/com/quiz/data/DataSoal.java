...
public class DataSoal {
    public String [][] pertanyaan = new String[][]{
            {"01", "Dibawah ini terdapat contoh beberapa larutan:\n 1) Asam Klorida,\n 2) Cuka,\n 3) Ammonia,\n 4)Air Kapur,\n " +
                    "5) Gula.\n Dari contoh di atas yang merupakan larutan asam lemah dan basa lemah berturut-turut adalah …\n", "2 dan 4"},
            {"02", "Larutan yang keduanya terhidrolisis sebagian dan bersifat asam adalah …", "NH4Cl dan (NH  4)2SO4"},
            {"03", "Garam yang mengalami hidrolisis total adalah …", "CH3COONH4"},
            {"04", "Garam di bawah ini tidak  mengalami hidrolisis adalah …", "K2SO4"},
            {"05", "Persamaan reaksi hidrolisis :\n" +
                    "XY + H2O == XOH + Y- + H+\n Rumus garam yang dapat mengalami hidrolisis seperti persamaan di atas adalah …", ""},
            {"06", "Garam berikut yang larutannya bersifat asam adalah …", "NH4Cl"},
            {"07", "", ""},
            ...
            {"11", "Pernyataan yang benar bahwa larutan CH3COONa dalam air mempunyai pH > 7 adalah ….", ""},
            {"12", "Bila 200 mL HCl 0,1 M dicampur dengan 100 mL NH3 0,2 M pernyataan yang benar adalah akan terbentuk….", ""},
    ...
    public String[][] pilihan = new String[][]{
            {"1 dan 4", "2 dan 4", "1 dan 5", "2 dan 3", "3 dan 5"},
            {"CH3COONH4 dan CH3COOK", "NH4Cl dan (NH  4)2SO4", "NH4Cl dan (NH  4)2CN", "NaCN dan CH3COOK", "KCN dan KCl"},
            {"NH4Cl", "CH3COONH4", "CH3COOK", "NaCN", "KCl"},
            {"CH3COONa", "K2SO4", "NH4Cl", "HCOOK", "NH4NO3"},
            {"(NH4)2S","NH4Cl","Na2SO4","KCN","CaCl2"},
            {"KBr","NH4Cl","(NH4)2CO3","CH3COOK","NaCl"},
            {"","","","",""},
    ...
    public String getJawaban(int x){
        return pertanyaan[x][2];
    }

    public String getPilihan(int x, int y){
        return pilihan[x][y];
    }
}
